...
public class testCiudadPaisContinente extends SpringTest {
	...
	public void precargaDatos () {
		continente1 = new Continente("Ocean�a");
		...
		pais3 = new Pais("Argentina", 42300000, "Espa�ol", continente2);
		pais4 = new Pais("Brasil", 58750000, "Portugues", continente2);
		pais5 = new Pais("Per�", 27500000, "Espa�ol", continente2);
		...
		pais13 = new Pais("Espa�a", 45623000, "Espa�ol", continente5);
		...
		ciudad21 = new Ciudad("N�poles", pais14, coordenadas21);
